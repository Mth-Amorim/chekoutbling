...
import { ShoppingCart, ScanBarcode, Plus, Trash2, CheckCircle2 } from "lucide-react";
    ...
    <div className="space-y-6">
      ...
      >
        <div className="flex items-center gap-3 mb-4">
          ...
          <h2 className="text-lg font-semibold text-foreground">Pedido de Compra</h2>
        </div>
        ...
        {!orderConfirmed ? (
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="font-mono text-lg text-foreground">Compra #{orderNumber}</span>
            </div>
